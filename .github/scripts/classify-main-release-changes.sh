...
while IFS= read -r changed_path; do
  case "${changed_path}" in
    ...
    .github/workflows/monitoring-verification.yml|.github/workflows/terraform-verification.yml|.github/workflows/backend-dev-image.yml)
      ;;
    compose.monitoring.yml|compose.monitoring.dev.yml|monitoring/*|infra/*|load-tests/*|scripts/loadtest/*|reference/*|docs/*|presentation/*|evidence/*|output/*|.agents/*|.codex/*|README.md|AGENTS.md|.gitignore|.gitattributes|.DS_Store)
      ;;
    *)
