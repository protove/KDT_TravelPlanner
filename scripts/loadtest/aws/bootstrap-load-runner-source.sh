...
lines = [
    ...
    'for route in "/v1/places:searchText" "/v1/places:searchNearby" "/v1/places/loadtest-place"; do curl --fail --silent --show-error --max-time 3 "http://127.0.0.1:8080${route}" >/dev/null; done',
